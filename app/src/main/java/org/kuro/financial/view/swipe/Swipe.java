package org.kuro.financial.view.swipe;
 ...
 */
public class Swipe extends RelativeLayout implements SwipeViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
     ...
     */
    @Deprecated
    public void setmAdapter(SwipeAdapter mAdapter) {
        this.mAdapter = mAdapter;
    }

    public void loadImage(SwipeAdapter mAdapter) {
        this.mAdapter = mAdapter;
    }
    ...
    private void init(Context context) {
        ...
        mPointLeftRightPadding = SwipeUtils.dp2px(context, 3);
        mPointTopBottomPadding = SwipeUtils.dp2px(context, 6);
        mPointContainerLeftRightPadding = SwipeUtils.dp2px(context, 10);
        mClipChildrenLeftMargin = SwipeUtils.dp2px(context, 30);
        mClipChildrenRightMargin = SwipeUtils.dp2px(context, 30);
        mClipChildrenTopBottomMargin = SwipeUtils.dp2px(context, 10);
        mViewPagerMargin = SwipeUtils.dp2px(context, 10);
        mTipTextSize = SwipeUtils.sp2px(context, 10);
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.Swipe);
        if (typedArray != null) {
            mIsAutoPlay = typedArray.getBoolean(R.styleable.Swipe_isAutoPlay, true);
            mIsHandLoop = typedArray.getBoolean(R.styleable.Swipe_isHandLoop, false);
            mIsTipsMarquee = typedArray.getBoolean(R.styleable.Swipe_isTipsMarquee, false);
            mAutoPlayTime = typedArray.getInteger(R.styleable.Swipe_AutoPlayTime, 5000);
            mPointsIsVisible = typedArray.getBoolean(R.styleable.Swipe_pointsVisibility, true);
            mPointPosition = typedArray.getInt(R.styleable.Swipe_pointsPosition, CENTER);
            mPointContainerLeftRightPadding = typedArray.getDimensionPixelSize(R.styleable.Swipe_pointContainerLeftRightPadding, mPointContainerLeftRightPadding);
            mPointLeftRightPadding = typedArray.getDimensionPixelSize(R.styleable.Swipe_pointLeftRightPadding, mPointLeftRightPadding);
            mPointTopBottomPadding = typedArray.getDimensionPixelSize(R.styleable.Swipe_pointTopBottomPadding, mPointTopBottomPadding);
            mPointContainerPosition = typedArray.getInt(R.styleable.Swipe_pointContainerPosition, BOTTOM);
            mPointContainerBackgroundDrawable = typedArray.getDrawable(R.styleable.Swipe_pointsContainerBackground);
            mPointNormal = typedArray.getResourceId(R.styleable.Swipe_pointNormal, R.drawable.shape_point_normal);
            mPointSelected = typedArray.getResourceId(R.styleable.Swipe_pointSelect, R.drawable.shape_point_select);
            mTipTextColor = typedArray.getColor(R.styleable.Swipe_tipTextColor, mTipTextColor);
            mTipTextSize = typedArray.getDimensionPixelSize(R.styleable.Swipe_tipTextSize, mTipTextSize);
            mIsNumberIndicator = typedArray.getBoolean(R.styleable.Swipe_isShowNumberIndicator, mIsNumberIndicator);
            mNumberIndicatorBackground = typedArray.getDrawable(R.styleable.Swipe_numberIndicatorBacgroud);
            mIsShowIndicatorOnlyOne = typedArray.getBoolean(R.styleable.Swipe_isShowIndicatorOnlyOne, mIsShowIndicatorOnlyOne);
            mPageChangeDuration = typedArray.getInt(R.styleable.Swipe_pageChangeDuration, mPageChangeDuration);
            mPlaceholderDrawableResId = typedArray.getResourceId(R.styleable.Swipe_placeholderDrawable, NO_PLACE_HOLDER);
            mIsClipChildrenMode = typedArray.getBoolean(R.styleable.Swipe_isClipChildrenMode, false);
            mClipChildrenLeftMargin = typedArray.getDimensionPixelSize(R.styleable.Swipe_clipChildrenLeftMargin, mClipChildrenLeftMargin);
            mClipChildrenRightMargin = typedArray.getDimensionPixelSize(R.styleable.Swipe_clipChildrenRightMargin, mClipChildrenRightMargin);
            mClipChildrenTopBottomMargin = typedArray.getDimensionPixelSize(R.styleable.Swipe_clipChildrenTopBottomMargin, mClipChildrenTopBottomMargin);
            mViewPagerMargin = typedArray.getDimensionPixelSize(R.styleable.Swipe_viewpagerMargin, mViewPagerMargin);
            mIsClipChildrenModeLessThree = typedArray.getBoolean(R.styleable.Swipe_isClipChildrenModeLessThree, false);
            mIsShowTips = typedArray.getBoolean(R.styleable.Swipe_isShowTips, false);
            mBannerBottomMargin = typedArray.getDimensionPixelSize(R.styleable.Swipe_bannerBottomMargin, mBannerBottomMargin);
            mShowIndicatorInCenter = typedArray.getBoolean(R.styleable.Swipe_showIndicatorInCenter, true);
            int scaleTypeIndex = typedArray.getInt(R.styleable.Swipe_android_scaleType, -1);
    ...
    private void initView() {
        ...
        if (mIsNumberIndicator) {
            ...
            mNumberIndicatorTv.setId(R.id.swipe_pointId);
            ...
            mPointRealContainerLl.setId(R.id.swipe_pointId);
        ...
        if (CENTER == mPointPosition) {
            ...
            pointLp.addRule(RelativeLayout.LEFT_OF, R.id.swipe_pointId);
        } else if (LEFT == mPointPosition) {
            mPointRealContainerLp.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
            if (mTipTv != null) {
                mTipTv.setGravity(Gravity.CENTER_VERTICAL | Gravity.RIGHT);
            }
            pointLp.addRule(RelativeLayout.RIGHT_OF, R.id.swipe_pointId);
    ...
    public void setData(@NonNull List<?> models, List<String> tips) {
        setData(R.layout.swipe_item_image, models, tips);
    }
    ...
    public void setBannerData(@NonNull List<? extends BaseBannerInfo> models) {
        setBannerData(R.layout.swipe_item_image, models);
    }
    ...
    private void initViewPager() {
        ...
        currentPos = 0;
        mViewPager = new SwipeViewPager(getContext());
        mViewPager.setAdapter(new SwipePageAdapter());
    ...
    public void onPageScrolled(int position, float positionOffset,
        ...
        if (mTipTv != null && mData != null && mData.size() != 0 && mData.get(0) instanceof BaseBannerInfo) {
            if (positionOffset > 0.5) {
                mTipTv.setText(((BaseBannerInfo) mData.get(getRealPosition(position + 1))).getSwipeTitle());
                mTipTv.setAlpha(positionOffset);
            } else {
                mTipTv.setText(((BaseBannerInfo) mData.get(getRealPosition(position))).getSwipeTitle());
    ...
    private void switchToPoint(int currentPoint) {
        ...
        if (mTipTv != null && mData != null && mData.size() != 0 && mData.get(0) instanceof BaseBannerInfo) {
            mTipTv.setText(((BaseBannerInfo) mData.get(currentPoint)).getSwipeTitle());
        } else if (mTipTv != null && mTipData != null && !mTipData.isEmpty()) {
        ...
        if (mViewPager != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (touchX >= paddingLeft && touchX < SwipeUtils.getScreenWidth(getContext()) - paddingLeft) {
                        stopAutoPlay();
                    }
                    break;
    ...
    public void setViewPagerMargin(@Dimension int viewPagerMargin) {
        ...
        if (mViewPager != null) {
            mViewPager.setPageMargin(SwipeUtils.dp2px(getContext(), viewPagerMargin));
        }
    }
    ...
    private static class AutoSwitchTask implements Runnable {
        private final WeakReference<Swipe> mXBanner;

        private AutoSwitchTask(Swipe mXBanner) {
            this.mXBanner = new WeakReference<>(mXBanner);
        }

        @Override
        public void run() {
            Swipe banner = mXBanner.get();
            if (banner != null) {
    ...
    public interface OnItemClickListener {
        void onItemClick(Swipe banner, Object model, View view, int position);
    }

    public interface SwipeAdapter {
        void loadBanner(Swipe banner, Object model, View view, int position);
    }
                ...
                if (mOnItemClickListener != null && !mData.isEmpty()) {
                    itemView.setOnClickListener(new OnDoubleClickListener() {
                        ...
                        public void onNoDoubleClick(View v) {
                            ...
                            mOnItemClickListener.onItemClick(Swipe.this, mData.get(realPosition), v, realPosition);
                        }
                    });
                }
                if (null != mAdapter && !mData.isEmpty()) {
                    mAdapter.loadBanner(Swipe.this, mData.get(realPosition), itemView, realPosition);
                }
            } else {
            ...
            view.setOnClickListener(new OnDoubleClickListener() {
                ...
                public void onNoDoubleClick(View v) {
                    if (null != mOnItemClickListener)
                        mOnItemClickListener.onItemClick(Swipe.this, mData.get(position), v, position);
                }
            });
    }
}
