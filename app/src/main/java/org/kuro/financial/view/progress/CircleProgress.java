package org.kuro.financial.view.progress;
...
public class CircleProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        progressColor = typedArray.getColor(R.styleable.CircleProgress_progress_color, Color.GREEN);
        bgColor = typedArray.getColor(R.styleable.CircleProgress_bg_color, Color.GRAY);
        startAngle = typedArray.getFloat(R.styleable.CircleProgress_start_angle, 0);
        sweepAngle = typedArray.getFloat(R.styleable.CircleProgress_sweep_angle, 360);
        barWidth = typedArray.getDimension(R.styleable.CircleProgress_bar_width, DisplayUtil.dip2px(context, 10));
        typedArray.recycle();

        progressNum = 0;
        maxNum = 100;
        defaultSize = DisplayUtil.dip2px(context, 100);
        mRectF = new RectF();
